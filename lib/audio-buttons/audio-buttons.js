...
hmTTS.prototype.showConfigSheet = function () {
  ...
  var configSheetHTML = `<div class="sheet-modal hm-audio-config-sheet" role="dialog" aria-labelledby="hm-audio-rate-title" aria-modal="true">
    ...
    "0.25"
  )}" role="radio" aria-checked="${getAriaChecked("0.25")}" tabindex="0" data-hm-audio-rate="0.25">0.25x <span class="hm-rateoption-caption">(${audioStrings["slowspeedcaption"]
    })</span></a></li>
            <li><a href="#" class="button hm-audio-rateoption-button ${getActiveClass(
      "0.5"
      ...
      "1.5"
            ...
            <li><a href="#" class="button hm-audio-rateoption-button ${getActiveClass(
      "1.75"
    )}" role="radio" aria-checked="${getAriaChecked("1.75")}" tabindex="0" data-hm-audio-rate="1.75">1.75x <span class="hm-rateoption-caption">(${audioStrings["fastspeedcaption"]
    })</span></a></li>
          </ul>
        </div>
      </div>
