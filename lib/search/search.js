...
function createGlobalSearchBar(app, $pageEl, resources) {
  ...
  $clearButton.attr("aria-label", resources.get("search").ariaLabels.clear);
...
<form class="searchbar searchbar-local">
  <div class="searchbar-inner">
    ...
    <span class="search-disable-button" role="button" tabindex="0" aria-label="{{closeLabel}}"><i class="icon material-icons" aria-hidden="true">close</i></span>
  </div>
</form>
...
function initalizeLocalPageSearch(app, appConfig, resources, $pageEl) {
  $$(".local-search", $pageEl[0]).each(function () {
    const context = {
      placeholder: $$(this).data("placeholder") || resources.get("search").prompt,
      closeLabel: resources.get("search").ariaLabels.close,
    };
