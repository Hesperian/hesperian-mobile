...
<div id="language-choices" class="list list-block">
  <ul>
    ...
    <li class="panel-close">
      <a href="#" data-subject="{{settings.sharing.subject}}" data-url="https://hesperian.org/books-and-resources/our-mobile-applications" data-ga-event="appsharing" class="socialsharing item-link item-content settings-header panel-close">
        <div class="item-media">
