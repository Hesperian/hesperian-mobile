...
<div class="sheet-modal favorites-sheet favorites-parent">
  <div class="toolbar">
    <div class="toolbar-inner">
      <div class="left"><i class="icon material-icons">close</i></div>
      <div class="title"></div>
      <div class="right">
        <a class="link sheet-close"><i class="icon material-icons">close</i></a>
      </div>
    </div>
  </div>
...
`);
  ...
  $$(document).on('keydown', '.favorites-parent .close-tile', function (e) {
