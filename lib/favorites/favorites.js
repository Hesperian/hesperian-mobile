...
import { isActivationKey, injectAriaIntoElement } from '../accessibility/accessibility';
...
<div class="sheet-modal favorites-sheet favorites-parent">
  <div class="toolbar">
    <div class="toolbar-inner">
      <div class="left"></div>
      <div class="title" data-aria-content="common.favorites.title"></div>
      <div class="right">
        <a class="link sheet-close" role="button" tabindex="0" data-aria-label="common.favorites.ariaLabels.close"><i class="icon material-icons">close</i></a>
      </div>
    </div>
  </div>
...
`);
  ...
  function updateFavoritesList(contextEl) {
    ...
    const favorites = resources.get('common.favorites');
    ...
    on: {
      open: function (sheet) {
       ...
       // $$('.toolbar-inner .title', favoritesSheet.el).html(favorites.title);
        injectAriaIntoElement(favoritesSheet.el);
