...
<div class="toolbar toolbar-bottom-md app-toolbar toolbar-audio" style="display: none;" role="toolbar" data-aria-label="common.audio.ariaLabels.audioToolbar">
  <div class="toolbar-inner">
    <a class="button hm-audio-button-previous audio-button" role="button" tabindex="0" data-aria-label="common.audio.ariaLabels.previousBlock"><i class="material-icons md-only" aria-hidden="true">${previousIcon}</i></a>
    <a class="button md-only hm-audio-button-start audio-button" role="button" tabindex="0" data-aria-label="common.audio.ariaLabels.play"><i class="material-icons" aria-hidden="true">${playIcon}</i></a>
    <a class="button md-only hm-audio-button-pause audio-button" role="button" tabindex="0" data-aria-label="common.audio.ariaLabels.pause"><i class="material-icons" aria-hidden="true">${pauseIcon}</i></a>
    <a class="button md-only hm-audio-button-stop audio-button" role="button" tabindex="0" data-aria-label="common.audio.ariaLabels.stop"><i class="material-icons" aria-hidden="true">stop</i></a>
    <a class="button md-only hm-audio-button-next audio-button" role="button" tabindex="0" data-aria-label="common.audio.ariaLabels.nextBlock"><i class="material-icons" aria-hidden="true">${nextIcon}</i></a>
    <a class="button md-only hm-audio-button-close audio-button" role="button" tabindex="0" data-aria-label="common.audio.ariaLabels.closeControls"><i class="material-icons" aria-hidden="true">close</i></a>
    <a class="button md-only hm-audio-button-rate audio-button" role="button" tabindex="0" aria-haspopup="dialog" data-aria-label="common.audio.ariaLabels.speechRate"><i class="material-icons" aria-hidden="true">${avTimerIcon}</i></a>
  </div>
...
function getTemplates(config) {
  ...
  if (bt) {
    ...
    context.buttons.push(
      `<a class="button toolbar-audio-button-play" href="#" role="button" tabindex="0" aria-expanded="false" data-aria-label="common.audio.ariaLabels.openAudioControls"><i class="icon material-icons" aria-hidden="true">${audioIcon}</i></a>`,
