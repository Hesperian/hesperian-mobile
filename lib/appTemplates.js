...
function getTemplates(config) {
  ...
  const appTemplates = {
    ...
    <div class="navbar-inner navbar-top">
      ...
      <h1 class="title"><a href="https://hesperian.org/" class="inline-link external"><img src="img/HHG-logo-small-circle.png" class="center hesperian-logo-image" style="height:45px;" /></a></h1>
      <div class="right">
