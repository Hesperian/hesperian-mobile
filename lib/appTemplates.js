...
function getTemplates(config) {
  ...
  const appTemplates = {
    ...
    <div class="navbar-inner navbar-top">
      ...
      <div class="title"><a href="https://hesperian.org/" class="inline-link external"><img src="img/HHG-logo.png" class="hesperian-logo-image" data-aria-label="common.logoAltText" alt="Hesperian Home" /><span class="logo-text">hesperian.org</span></a></div>
      <div class="right">
