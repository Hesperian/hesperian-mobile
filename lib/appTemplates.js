...
function getTemplates(config) {
  ...
  const appTemplates = {
    ...
    <div class="navbar-inner navbar-top">
      <div class="left">
        <a href="#" class="link icon-only panel-open" data-panel="left" id="top-left-menu">
          <i class="icon material-icons">menu</i>
        </a>
      </div>
      <div class="title"><a href="https://hesperian.org/" class="inline-link external"><img src="img/HHG-logo-small-circle.png" class="center" id="hesperian-logo-image" style="height:45px;" /></a></div>
      <div class="right">
        <a href="#" class="link icon-only panel-open" data-panel="right" id="top-right-menu">
