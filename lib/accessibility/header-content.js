...
$$(document).on('page:init', function (e) {
  ...
  Array.prototype.forEach.call(logoImages, function(logoImage) {
    if (logoImage !== null) {
      const logoAltText = resources.get("common.logoAltText");
  ...
  Array.prototype.forEach.call(upperLeftMenus, function(upperLeftMenu) {
    if (upperLeftMenu !== null) {
      const upperLeftMenuAriaLabel = resources.get("common.upperLeftMenuAriaLabel");
  ...
  Array.prototype.forEach.call(upperRightMenus, function(upperRightMenu) {
    if (upperRightMenu !== null) {
      const upperRightMenuAriaLabel = resources.get("common.upperRightMenuAriaLabel");
  ...
  Array.prototype.forEach.call(backButtons, function(backButton) {
    if (backButton !== null) {
      const backButtonAriaLabel = resources.get("common.backButtonAriaLabel");
